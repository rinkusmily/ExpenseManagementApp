...
public class ConfigTypesofExpenses extends AppCompatActivity {

    ImageView img_cancel_type;
    ImageView add_config;

    RecyclerView cart_recycler_view;
    private List<User> notifyModels;
    Context context;
    private ConfigTypeExpenseAdapter cartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_config_expense);
      ...
      //  submitRegister();
        ...
        add_config.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ConfigTypesofExpenses.this ,AddTypeExpense.class);
 ...
 /*   private void submitRegister() {
   ...
   *//*     final ProgressDialog progressDialog = new ProgressDialog(TypesofExpenses.this);
        progressDialog.setCancelable(false);
        progressDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        progressDialog.show();*//*

        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiService.EXPENSES_TYPE_LIST,
                        ...
                        try {
                           *//* if (progressDialog != null) {
                                ...
                                if (jo.getInt("status")==1)
                                {
                                    ...
                                    cartAdapter = new ConfigTypeExpenseAdapter(context, notifyModels, new RecyclerbuttonClick() {
                                        @Override
                                ...
                                {
                                    Toast.makeText(ConfigTypesofExpenses.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                                }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                      //  progressDialog.dismiss();
                        ...
                        Toast.makeText(ConfigTypesofExpenses.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                String user_id = new UserSession(ConfigTypesofExpenses.this).readPrefs(UserSession.PREFS_USER_ID);
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(ConfigTypesofExpenses.this);
    ...
    private void DeleteCaregoryApi(){
        ...
        final ProgressDialog progressDialog = new ProgressDialog(ConfigTypesofExpenses.this);
        progressDialog.setCancelable(false);
        progressDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiService.DELETE_EXPENSE_TYPE,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response){
                        Log.e("DIKSHA", "GET_EXPENSE_TYPE"+response);
    ...
    public  void fetchDataOffline(){
        ...
        try {
            ...
            Cursor cursor = dbManager.FETCH_CATEGORY_LIST(user_id , "expence");
            int i=0;

            notifyModels.clear();

            ExpenseListPojo fileListPojo = new ExpenseListPojo();
            ...
            if(cursor.moveToFirst()) {
                ...
                cartAdapter = new ConfigTypeExpenseAdapter(context, notifyModels, new RecyclerbuttonClick() {
                    ...
                    public void onItemClick(int position, int type) {
                        ...
                        final String  user_id = new UserSession(ConfigTypesofExpenses.this).readPrefs(UserSession.PREFS_USER_ID);

                       // Toast.makeText(context, "clicked", Toast.LENGTH_SHORT).show();
                        if(type==10){

                          Log.v("DIKSHAAAADELTE",">>>"+notifyModels.size()) ;

                            category_id  = ""+notifyModels.get(position).getCategoryId();

                            dbManager.DELETE_CATEGORY_BY_USER(user_id,"expence",category_id);
