...
public class ForgotPinLockOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_pin_lock_otp);
    ...
    private void initViews() {
        ...
        imv_backotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ForgotPinLockOtp.this, ForgotPinLock.class);
    ...
    private void OtpCheck() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (obj.getInt("status") == 1) {
                                ...
                                Intent intent = new Intent(ForgotPinLockOtp.this, PinLockActivity2.class);
                                intent.putExtra("email", useremail);
                                startActivity(intent);
                                finish();
                                Toast.makeText(ForgotPinLockOtp.this, R.string.otp_successfully_verify, Toast.LENGTH_SHORT).show();
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(ForgotPinLockOtp.this);
