...
public class PinLockActivityConfirm extends AppCompatActivity {
        ...
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getOTP.equals(otp)) {
                    ...
                    new UserSession(PinLockActivityConfirm.this).writePrefs(UserSession.PINLOCK,otp);
                    new UserSession(PinLockActivityConfirm.this).writePrefs(UserSession.STATUS_PINLOCK,"true");

                /*    Intent intent = new Intent(PinLockActivityConfirm.this ,SecuriryActiviry.class);
