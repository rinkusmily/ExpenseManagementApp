...
public class TypesofExpenses extends AppCompatActivity {

    ImageView img_cancel_type , img_config_expensce;

    RecyclerView cart_recycler_view;
    private List<User> notifyModels;
    Context context;
    private TypeExpenseAdapter cartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_config_expensce.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                Intent intent = new Intent(TypesofExpenses.this ,ConfigTypesofExpenses.class);
   ...
   *//*     final ProgressDialog progressDialog = new ProgressDialog(TypesofExpenses.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiService.EXPENSES_TYPE_LIST,
                        ...
                        try {
                           *//* if (progressDialog != null) {
                                ...
                                if (jo.getInt("status")==1)
                                {
                                    ...
                                    cartAdapter = new TypeExpenseAdapter(context, notifyModels, new RecyclerbuttonClick() {
                                        @Override
                                ...
                                {
                                    Toast.makeText(TypesofExpenses.this, jo.getString("message"), Toast.LENGTH_SHORT).show();
                                }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                      //  progressDialog.dismiss();
                        ...
                        Toast.makeText(TypesofExpenses.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                String user_id = new UserSession(TypesofExpenses.this).readPrefs(UserSession.PREFS_USER_ID);
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(TypesofExpenses.this);
