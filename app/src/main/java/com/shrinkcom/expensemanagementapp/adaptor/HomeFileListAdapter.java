...
public class HomeFileListAdapter extends RecyclerView.Adapter<HomeFileListAdapter.MyViewHolder>   {
    ...
    public HomeFileListAdapter(Context context, List<User> allModelList , RecyclerbuttonClick recyclerbuttonClick) {
...
//        GetFileListPojo notifyModel = allModelList.get(0);
        ...
        Log.v("DIKSHA_09","API_DATAcccccccccc >>>"+""+c);
        ...
        myViewHolder.ll_layout_swipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dnt_show_msg.equals("1")){
                    ...
                    Log.v("DIKSHAA_","CUREEEENCYYYYY>> "+allModelList_2.get(i).getCurrency());

                    Intent intent = new Intent(context, MainTotalBalanceAcitvity.class);
