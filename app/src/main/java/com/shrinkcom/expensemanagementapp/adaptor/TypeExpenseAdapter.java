...
public class TypeExpenseAdapter extends RecyclerView.Adapter<TypeExpenseAdapter.MyViewHolder> {
    RecyclerbuttonClick recyclerbuttonClick;
    private Context context;
    private List<User> cartModelList;

    public TypeExpenseAdapter(Context context, List<User> cartModelList , RecyclerbuttonClick recyclerbuttonClick) {
