...
public class TypePaymentAdapter extends RecyclerView.Adapter<TypePaymentAdapter.MyViewHolder> {
    ...
    public TypePaymentAdapter(Context context, List<com.shrinkcom.expensemanagementapp.Pojo.paymentTypePojo.User> cartModelList , RecyclerbuttonClick recyclerbuttonClick) {
