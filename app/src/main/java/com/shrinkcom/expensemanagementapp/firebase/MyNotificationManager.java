...
import static com.shrinkcom.expensemanagementapp.firebase.Constants.CHANNEL_ID;
...
public class MyNotificationManager {
    ...
    public void displayNotification(String title, String body) {
        ...
        String strid = session.getInstance(mCtx).readPrefs(UserSession.PREFS_USER_ID);
        if (strid.equals("")){
